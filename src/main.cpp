...
int main ( int argc, char* argv[] )
{
    ...
    for(;nig[0]*nig[1]/(nig[1]+(nig[0]-nig[1])*exp(-nig[2]*(days+approaching_days)))<0.99*nig[0];approaching_days++){}//99% of the peak number
    ...
    std::cout<<"The data collected is from 2020.01.17 to "<<1900+time_ptr->tm_year<<"."<<1+time_ptr->tm_mon<<"."<<time_ptr->tm_mday<<std::endl;
